...
- Step 24: ✅ RESOLVED (2026-07-07). Published `agent-chief` 0.3.1 to PyPI;
  verified `uvx agent-chief demo` and `uvx agent-chief --version` from the live
  index. Future releases publish automatically via Trusted Publishing
  (`.github/workflows/publish.yml`, no token) — see docs/PUBLISHING.md.
